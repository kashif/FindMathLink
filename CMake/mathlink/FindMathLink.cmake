...
if (WIN32)
	...
	MESSAGE("DBG MathLink_ROOT_DIR=${MathLink_ROOT_DIR}")
endif(WIN32)
...
ELSE(UNIX)
  ...
  MESSAGE("DBG MathLink_LIBRARY_DIR=${MathLink_LIBRARY_DIR}")
ENDIF(UNIX)
...
MARK_AS_ADVANCED(MathLink_LIBRARIES MathLink_INCLUDE_DIR MathLink_LIBRARY_DIR)
